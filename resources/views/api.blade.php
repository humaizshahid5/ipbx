               ...
               <div class="row">
                  ...
                  <div class="col-6 my-auto">
                     <div class="float-right">
                        <a href="{{ route('api') }}"<button class="btn btn-primary btn-md"><i class="fas fa-plus"></i> Add New Number</button></a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <form action="/edit_api/{{ $edit->id }}/edit" method="POST">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-12 col-sm-12">
                        <br>
                        <button type="submit" class="btn btn-info btn-block">Edit API</button>
                     </div>
                  </div>
               </form>
               @endforeach
                  ...
                  <table id="usertable" class="table table-bordered table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><a href="/api/{{$api->id}}/edit"><button class="btn btn-info btn-block"><i class="fas fa-edit"></i></button></a></td>
